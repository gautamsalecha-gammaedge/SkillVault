...
class WorkerRegisterRequest(BaseModel):
    # worker_id is auto-generated by the backend and returned after registration.
    password: str
    name: str
...
class WorkerUpdateProfileRequest(BaseModel):
    """Worker can update their own name / phone / address (not password, not worker_id)."""
...
class AdminUpdateWorkerRequest(BaseModel):
    """Admin can update any worker field except password. Can also rename worker_id."""
    worker_id: Optional[str] = None  # new worker_id if renaming
    name: Optional[str] = None
    phone: Optional[str] = None
    address: Optional[str] = None
...
class AdminUpdateProfileRequest(BaseModel):
    """Admin display-name only (login credentials stay in env)."""
    name: str
